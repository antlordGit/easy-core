...
public class ApiLexer implements FlexLexer {
    ...
    public static IElementType KEY = new IElementType("KEY", ApiLanguage.INSTANCE);
    public static IElementType COMMENT = new IElementType("COMMENT", ApiLanguage.INSTANCE);
    public static IElementType SEPARATOR = new IElementType("SEPARATOR", ApiLanguage.INSTANCE);
    public static IElementType VALUE = new IElementType("VALUE", ApiLanguage.INSTANCE);
    public static IElementType PROPERTY = new IElementType("PROPERTY", ApiLanguage.INSTANCE);
    public static IElementType CRLF = new IElementType("CRLF", ApiLanguage.INSTANCE);
