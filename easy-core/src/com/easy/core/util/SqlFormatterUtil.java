...
public class SqlFormatterUtil {
    ...
    private static class FormatProcess {
        ...
        private static boolean isFunctionName(String tok) {
            ...
            return isIdentifier && !SqlFormatterUtil.LOGICAL.contains(tok) && !SqlFormatterUtil.END_CLAUSES.contains(tok) && !SqlFormatterUtil.QUANTIFIERS.contains(tok) && !SqlFormatterUtil.DML.contains(tok) && !SqlFormatterUtil.MISC.contains(tok);
        }
